<?php $this->renderFile('protected/views/layouts/header_subpanel.php', array('title'=>'Update Account')); ?>
  ...
  <table border="0">
    ...
    <tr>
      ...
      <td class="element">
        ...
        <span name="correct" style="display: none; color: #f00; "></span>
      </td>
    </tr>
    <tr>
