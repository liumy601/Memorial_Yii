...
?>
  ...
  <table>
	...
	<tr>
		<td class="label"> </td>
    <td class="element"><?php echo CHtml::link('Reset Password', 'site/resetPassword');?><br/><?php echo $form->checkBox($model,'rememberMe') . $form->label($model,'rememberMe') . $form->error($model,'rememberMe'); ?></td>
	</tr>
