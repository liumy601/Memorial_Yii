    ...
    <tr height="20" id="action_<?php echo $data->id; ?>">
      <td width="20">
        <div align="center" id="divaction_<?php echo $data->id; ?>" class="indIcon" style="visibility: hidden; ">
          <a class="link" id="listViewEdit_action_<?php echo $data->id; ?>" href="/decedent/update/<?php echo $data->id; ?>">Edit</a>&nbsp;&nbsp;&nbsp;
          <a class="link" id="listViewDelete_action_<?php echo $data->id; ?>" href="#" url="/decedent/delete/<?php echo $data->id; ?>" onclick="return(deleteRecord(this));">Delete</a>
        </div>
      </td>
        <?php
        }
...
?>
  ...
  <td scope="row" align="left" valign="top" class="<?php echo ($i % 2) ? 'oddListRowS1' : 'evenListRowS1'; ?>" bgcolor="#ffffff">
    ...
    <?php if($data->form_type == 'old'){?>
      ...
      <a style="display:block;" id="detailview_action_<?php echo $data->id; ?>" pagetitle="View Customer" href="/decedent/view/<?php echo $data->id; ?>" class="listViewTdLinkS1"><?php echo CHtml::encode($data->$field); ?></a>
      <?php } else { ?>
    ...
    <?php }elseif($data->form_type == 'new'){?>
      <?php if($field == 'full_legal_name') { ?>
    <!--<a style="display:block;" id="detailview_action_<?php // echo $data->id; ?>" pagetitle="View Customer" href="/customer/view/<?php // echo $data->id; ?>" class="listViewTdLinkS1"><?php // echo CHtml::encode($data->$field); ?></a>-->
    <a style="display:block;" id="detailview_action_<?php echo $data->id; ?>" pagetitle="View Customer" href="/decedent/viewnewcustomer/<?php echo $data->id; ?>" class="listViewTdLinkS1"><?php echo CHtml::encode($data->$field); ?></a>
      <?php } else { ?>
    <?php echo CHtml::encode($data->$field); ?>
    <?php } ?>
    <?php }?>
...
<script type="text/javascript">
  ...
  function customers_export(){
    document.location.href = '/decedent/customersexport';
  }
