...
<?php
  $title = 'Add Products to Package: ' . $package->name;
?>
...
<?php
$products = Inventory::getAllForPackage($package->id);
if ($products) {
?>
<form method="post" action="/package/addproduct/<?php echo $package->id; ?>">
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td align="center">
    ...
    <input title="Cancel" class="button buttonurl" url="/package/view/<?php echo $package->id; ?>" pageTitle="Package" type="button" name="button" value="Cancel"/>
  </td></tr></tbody></table>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tabForm">
      <tbody>
        <tr> 
          ...
          <td width="30%" class="element"><?php echo CHtml::checkBoxList('products', $_POST['products'], $products); ?></td>
        </tr>
      </tbody>
    </table>
  </div>
