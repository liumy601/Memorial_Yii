...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tabForm">
  <tbody>
    <tr>
      <td class="dataLabel" nowrap="nowrap" width="120"><?php echo CHtml::encode($customer->getAttributeLabel('name')); ?></td>
      <td class="dataField" nowrap="nowrap" width=""><?php echo $form->textField($customer, 'name'); ?></td>
    </tr>
  </tbody>
</table>
