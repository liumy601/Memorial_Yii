...
<div class="cvpadding">
  <table id="cvTable" width="100%" border="0" cellspacing="0" cellpadding="1">
    <tbody>
      <tr>
        <td> 
          <div class="floatL"><h1>Contact</h1></div>
...
?>
<?php $form=$this->beginWidget('CActiveForm', array('htmlOptions' => array('name'=>'EditView', 'id'=>'filter_form'))); ?>

<div class="filters">
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tabForm">
  <tbody>
    <tr>
      <td class="dataLabel" nowrap="nowrap" width="120"><?php echo CHtml::encode($contact->getAttributeLabel('full_name')); ?></td>
      <td class="dataField" nowrap="nowrap" width=""><?php echo $form->textField($contact, 'full_name'); ?></td>
    </tr>
  </tbody>
</table>
     ...
     ?>
      ...
      <td scope="col" width="<?php echo $width; ?>" class="listViewThS1" nowrap="">
        <div style="white-space: nowrap;" width="100%" align="left">
          <?php echo CHtml::encode($contact->getAttributeLabel($field)); ?>
        </div>
      </td>
    ...
    <tr height="20" id="action_<?php echo $data->id; ?>">
      <td width="20"> 
        <div align="center" id="divaction_<?php echo $data->id; ?>" class="indIcon" style="visibility: hidden; ">
          <a class="link" id="listViewEdit_action_<?php echo $data->id; ?>" href="/contact/update/<?php echo $data->id; ?>">Edit</a>&nbsp;&nbsp;&nbsp;
          <a class="link" id="listViewDelete_action_<?php echo $data->id; ?>" href="#" url="/contact/delete/<?php echo $data->id; ?>" onclick="return(deleteRecord(this));">Delete</a>
        </div>
      </td>
<?php
$i = 0;
...
?>
  ...
  <td scope="row" align="left" valign="top" class="<?php echo ($i % 2) ? 'oddListRowS1' : 'evenListRowS1'; ?>" bgcolor="#ffffff">
    <a style="display:block;" id="detailview_action_<?php echo $data->id; ?>" pagetitle="View Customer" href="/contact/view/<?php echo $data->id; ?>" class="listViewTdLinkS1"><?php echo CHtml::encode($data->$field); ?></a>
  </td>
