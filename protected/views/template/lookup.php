...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tabForm">
  <tbody>
    <tr>
      <td class="dataLabel" nowrap="nowrap" width="120"><?php echo CHtml::encode($template->getAttributeLabel('full_name')); ?></td>
      <td class="dataField" nowrap="nowrap" width=""><?php echo $form->textField($template, 'full_name'); ?></td>
    </tr>
  </tbody>
</table>
     ...
     ?>
      ...
      <td scope="col" width="<?php echo $width; ?>" class="listViewThS1" nowrap="">
        <div style="white-space: nowrap;" width="100%" align="left">
          <?php echo CHtml::encode($template->getAttributeLabel($field)); ?>&nbsp;&nbsp;
        </div>
      </td>
