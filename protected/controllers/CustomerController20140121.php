                    ...
                    <tbody>
                      <tr>
                        <td colspan="2">'.ucwords($paymentData['company_name']).'<br/>
                          ...
                          '.($paymentData['company_city'] != '' ? $paymentData['company_city'].', ' : '').$paymentData['company_state'].' '.$paymentData['company_zip'].'<br/>
                        </td>
                        <td rowspan="2" colspan="2" style="text-align: center;">
                         '.(file_exists($paymentData['company_logo']) ? '<img id="img_logo" src="'.$paymentData['company_logo'].'" width="180px" height="120px"/>' : '<img id="img_logo" width="180px" height="120px" style="display: none;"/>').' 
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                      ...
                      <tr>
                         <td colspan="2" valign="bottom">Payor:<br/></td>
                      </tr>
                      <tr>
                         <td colspan="4">'.$paymentData['payer'].'<br/>
                                 '.$paymentData['address'].'<br/>
                                 '.$paymentData['city'].' '. $paymentData['state'].' '.$paymentData['zip'].'<br/>
                         </td>
                      </tr>
                      <tr>
                        <td><br/></td>
                    ...
                    <tbody>
                      <tr>
                        <td colspan="4" style="text-align: center;">
                          <table class="tab" style="width:700px;" cellpadding="1">
                            <tr>
                              <td width="20%" class="align1" nowrap="nowrap">Payment Date:</td><td class="align2" width="30%" nowrap="nowrap">'.$paymentData['date'].'</td>
                              <td width="30%" class="align1" nowrap="nowrap">Balance due before payment:</td><td class="align2" width="20%" nowrap="nowrap">$'.$paymentData['balance_before_payment'].'</td>
                            </tr>
                            <tr>
                              <td width="20%" class="align1" nowrap="nowrap">Method:</td><td class="align2" width="30%" nowrap="nowrap">'.$paymentData['payment_method'].'</td> 
                              <td width="30%" class="align1" nowrap="nowrap">Discount:</td><td class="align2" width="20%" nowrap="nowrap">'.$paymentData['discount'].'</td>
                            </tr>
                            <tr>
                              <td width="20%" class="align1" nowrap="nowrap">Check No.</td><td class="align2" width="30%" nowrap="nowrap">--</td>
                              <td width="30%" class="align1" nowrap="nowrap">Balance due on account:</td><td class="align2" width="20%" nowrap="nowrap">'.$paymentData['balance_due_account'].'</td>
                            </tr>         
                          </table>    
                        </td>
                      </tr>
     ...
     $document='<table class="fontSize">
                    <tbody>
                      <tr>
                        ...
                        <td rowspan="2" colspan="2" style="text-align: center;">
                           '.(file_exists($paymentData['company_logo']) ? '<img id="img_logo" src="'.$paymentData['company_logo'].'" width="180px" height="120px"/>' : '<img id="img_logo" width="180px" height="120px"/>').' 
                        </td>
                      </tr>
                      <tr>
                         <td colspan="2"></td>
                      ...
                      <tr>
                        <td colspan="4" style="text-align: center;">
                          <table class="tab" style="width:700px;" cellpadding="1">
                            ...
                            <tr>
                              <td width="20%" class="align1" nowrap="nowrap">Method:</td><td class="align2" width="30%" nowrap="nowrap">'.$paymentData['payment_method'].'</td> 
                              <td width="30%" class="align1" nowrap="nowrap">Payment:</td><td class="align2" width="20%" nowrap="nowrap">'.$paymentData['amount'].'</td>
                            </tr>
                            <tr>
                              <td width="20%" class="align1" nowrap="nowrap">Check No.</td><td class="align2" width="30%" nowrap="nowrap">--</td>
                              <td width="30%" class="align1" nowrap="nowrap">Balance due on account:</td><td class="align2" width="20%" nowrap="nowrap">'.$paymentData['balance_due_account'].'</td>
