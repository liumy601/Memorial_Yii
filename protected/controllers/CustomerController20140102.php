...
//    $document = $this->_populateTemplateVars($customer, $template);
    ...
    if($type == 'discount'){
      $document='<table class="fontSize">
                    <tbody>
                      <tr>
                        <td colspan="2">Summer Kistler Funeral Home, Olney<br/>
                          P.O. Box 98 205 E. Elm St.<br/>
                          Olney, IL 62450<br/><br/><br/>
                        </td>
                        <td rowspan="2" colspan="2" style="text-align: center;">
                          <img id="img_logo" src="'.$paymentData['logo'].'" width="180px" height="120px"/>
                        </td>
                      </tr>
                      <tr>
                         <td colspan="2" valign="bottom">Payor:</td>
                      </tr>
                      <tr>
                         <td colspan="4">
                           <table class="tab" style="width:400px;">
                             <tr>
                               <td>Joyce Price<br/>
                                 P.O. Box 16<br/>
                                 Calhoun, IL  62419<br/>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td colspan="4" style="font-weight: bold; nowrap: nowrap; text-align: center;">
                          Receipt of payment for the services of Imogene Clark
                        </td>
                      </tr>
                    </tbody>
