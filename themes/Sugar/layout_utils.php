...
global $image_path;
global $app_strings;
$blank = getWebPath('include/images/blank.gif');
$the_form = '';
...
$the_form = "</p><IMG height='6' width='1' src='$blank' alt=''><p>";
}
...
$the_form .= "<td colspan='10' width='100%'><IMG height='1' width='1' src='$blank' alt=''></td>\n";
	$the_form .= "</tr><tr>\n";
	$the_form .= "<td align='left' valign='middle' nowrap style='padding-bottom: 2px;'>$other_text</td>\n";
	$the_form .= "<td width='100%'><IMG height='1' width='1' src='$blank' alt=''></td>\n";
...
class='utilsLink'>".$app_strings['LNK_HELP']."</A></td>\n";
	...
	if ($other_text && $is_min_max === false) {
		$the_form .= "<td width='20'><IMG height='1' width='20' src='$blank' alt=''></td>\n";
...
if ($show_help) {
		...
		if ($_REQUEST['action'] != "EditView" && $_REQUEST['action'] != "EditView") {
