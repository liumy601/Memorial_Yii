...
if(x>=0&&y>=0){layer.style.left=x+'px';layer.style.top=y+'px';}}}
...
continue;objLeft=obj.offsetLeft;objTop=obj.offsetTop;objParent=obj.offsetParent;while(objParent.tagName.toUpperCase()!="BODY"){objLeft+=objParent.offsetLeft;objTop+=objParent.offsetTop;objParent=objParent.offsetParent;}
...
function checkBrowser(){if(!is.ie5up&&!is.nav6up){}}
function runPageLoadItems(){var myVar;checkBrowserWidth();}
var is=new Is();checkBrowser();if(is.ie){document.write('<style type="text/css">');document.write('body {font-size: x-small;}');document.write('</style>');}
